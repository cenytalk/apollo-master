 ...
 * 表AppNamespace
 * App下Namespace的元信息
 * 库apolloconfigdb 和 apolloportaldb 中都存在
...
public class AppNamespace extends BaseEntity {
  ...
  private String name;//namespace名字，注意，需要全局唯一

  @NotBlank(message = "AppId cannot be blank")
  @Column(name = "AppId", nullable = false)
  private String appId;//App : AppNamespace = 1 : N

  @Column(name = "Format", nullable = false)
  private String format;//namespace的format类型 在ConfigFileFormat类中

  @Column(name = "IsPublic", columnDefinition = "Bit default '0'")
  private boolean isPublic = false;//namespace是否为公共
