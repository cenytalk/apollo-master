...
public class AppController {
  ...
  public App create(@Valid @RequestBody AppModel appModel) {
    ...
    //portal创建app项目 保存到apolloportaldb数据库中
    App createdApp = appService.createAppInLocal(app);

    //发布AppCreationEvent事件,CreationListener类进行监听事件，调用Admin Service API向apollo-adminservice发送请求
    //将app创建同步到apollo-adminservice的数据库中
